(function () {
    ...
    const svg = d3.select("#selected-countries-visualization svg")
        .attr("width", width)
    ...
    Promise.all([
        ...
        const highlightedCountries = educationData
            .filter(d => d["Fertility Rate"] < 1.3 && d["Labor force participation rate"] > 50)
        ...
        ranges.forEach((range, i) => {
            ...
            countriesInRange.forEach(country => {
                ...
                const circle = chart.append("circle")
                    ...
                    .attr("stroke", highlightedCountries.includes(country["Country"]) ? "black" : "rgb(197, 236, 113)")
